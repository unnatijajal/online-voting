<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="subadmin_login.aspx.cs" Inherits="subadmin_login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr style="height: 57px">
        <td colspan="2" style="text-align:center">
            Don&#39;t have an account?&nbsp;<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/subadmin_registration.aspx">Registration</asp:HyperLink>
        </td>
    </tr>
</table>
</center>
