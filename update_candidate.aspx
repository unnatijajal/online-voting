<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="update_candidate.aspx.cs" Inherits="update_candidate" %>
            ...
            <div class="main">
                <div class="contr">
                    <div class="registration-form">
                        <h2 class="h2_ud">Update Candidate</h2>
                        ...
                        <asp:Button ID="submit" runat="server" Text="Update" Height="37px" Width="137px" CssClass="submit"/>
                    </div>
                </div>
            </div>
        </body>
