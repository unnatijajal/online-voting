<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage1.master" AutoEventWireup="true" CodeFile="party_registration.aspx.cs" Inherits="party_registration" %>
           ...
           <div class="main">
               <div class="contr">
                   <div class="registration-form">
                       ...
                       <asp:Button ID="submit" runat="server"  CssClass="submit" Text="Registration" Height="37px" Width="137px" OnClick="submit_Click" />
                   </div>
               </div>
           </div>
