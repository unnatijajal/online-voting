<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="add_party.aspx.cs" Inherits="add_party" %>
           ...
           <div class="main">
               <div class="contr">
                   <div class="registration-form">
                       ...
                       <asp:Button ID="submit" runat="server"  CssClass="submit" Text="Add" Height="37px" Width="137px"  />
                   </div>
               </div>
           </div>
